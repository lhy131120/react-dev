...
function App() {
  ...
  // 上傳圖片 input 參考
  const [uploadingImages, setUploadingImages] = useState(false); // 控制上傳區塊顯示
  const [previewImage, setPreviewImage] = useState(null); // 本地預覽
  const [selectedFile, setSelectedFile] = useState(null); // 選擇的檔案
  const [isUploading, setIsUploading] = useState(false); // 上傳中狀態
  const uploadImageInputRef = useRef(null); // input type="file" 參考
    ...
    try {
      const payload = {
        data: {
          ...
          imagesUrl: (tempProduct.imagesUrl || []).filter(
            (url) => url && url.trim() !== ""
          ),
          label: (tempProduct.label || []).filter(
            (tag) => tag && tag.trim() !== ""
          ),
        },
      };
  ...
  useEffect(() => {
    ...
    deleteItemModalRef.current.addEventListener(
      "hide.bs.modal",
      handleModalHide
    );
    deleteItemModalRef.current.addEventListener(
    ...
    [productModalRef, adminModalRef, deleteItemModalRef, loginModalRef].forEach(
      (ref) => {
        if (ref.current) {
                  ...
                  <div key={item.id} className="col">
                    <div className="card h-100 shadow-sm hover-shadow transition">
                      ...
                      <div className="card-body d-flex flex-column">
                        <h2 className="fs-6 card-title fw-bold">
                          {item.title}
                        </h2>
                        ...
                        <button
                          ...
                          onClick={() => openModal("product", item)}
                        >
                          <small>查看細節</small>
                        </button>
                      </div>
                    ...
                    <div className="row">
                      ...
                      <div className="mb-3 col-lg-5">
                        ...
                        <input
                          ...
                          type="text"
                          className={`form-control ${
                            formErrors.subcategory ? "is-invalid" : ""
                          }`}
                          placeholder="請輸入次分類"
                    ...
                    <div className="row">
                      <div className="mb-3 col-lg-5">
                        ...
                        <input
                          ...
                          min="1"
                          className={`form-control ${
                            formErrors.origin_price ? "is-invalid" : ""
                          }`}
                          placeholder="請輸入原價"
                        ...
                        {tempProduct?.label?.map((tag, index) => (
                          <div key={index} className="input-group mb-2 mb-lg-0">
                            ...
                            <button
                              ...
                              type="button"
                              onClick={() => {
                                const newTags = tempProduct.label.filter(
                                  (_, i) => i !== index
                                );
                                setTempProduct((prev) => ({
                                  ...prev,
                    ...
                    <div className="mb-3 col-lg-8">
                      ...
                      <div className="d-flex align-items-center gap-2">
                        {tempProduct?.flavor?.map((flavor, index) => (
                          <div key={index} className="input-group mb-2 mb-lg-0">
                            ...
                            <button
                              ...
                              type="button"
                              onClick={() => {
                                const newFlavors = tempProduct.flavor.filter(
                                  (_, i) => i !== index
                                );
                                setTempProduct((prev) => ({
                                  ...prev,
                        ...
                        <button
                          type="button"
                          className={`btn btn-outline-primary w-100 ${
                            tempProduct.flavor?.length >= 2 ? "d-none" : ""
                          }`}
                          onClick={() => {
                            const newFlavors = [
                              ...(tempProduct.flavor || []),
                  ...
                  <div className="col-lg-4">
                      ...
                      {tempProduct.imageUrl && (
                        <div className="mt-2 border rounded overflow-hidden">
                          <img
                            ...
                            onError={(e) => {
                              e.target.src =
                                "https://dummyimage.com/600x400/000/fff&text=dummy";
                            }}
                          />
                        </div>
                      )}
                    ...
                    <div>
                      ...
                      {tempProduct.imagesUrl?.map((url, index) => (
                        <div
                          key={index}
                          className="input-group mb-3 align-items-center"
                        >
                          <div className="form-control bg-dark text-white border-0 d-flex align-items-center gap-2 p-2 position-relative">
                            <img
                              src={url}
                              alt={`附加圖片 ${index + 1}`}
                              className="rounded"
                          ...
                          <button
                            className="btn btn-danger text-white position-absolute rounded-0 end-0 top-0 z-1 d-flex justify-content-center align-items-center p-0"
                            style={{
                              transform: "scale(1)",
                              width: "24px",
                              height: "24px",
                      ...
                      <button
                        ...
                        onClick={() => setUploadingImages(true)} // 顯示上傳區塊
                      >
                        + 上傳新圖片
                      </button>
                        ...
                        <div className="border border-primary rounded p-3 mb-3 bg-dark bg-opacity-50">
                          <div className="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <button
                              ...
                              onClick={() => setUploadingImages(false)} // 取消上傳
                            >
                              取消
                            </button>
                          </div>
